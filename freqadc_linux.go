...
func (dev *FreqDevice) EnableADC(enableADC bool) (err error) {
	...
	err = dev.deviceIoControl(0x40, 0xB2, []byte{enb}, 1, 1000) //0xC0 in, 0x40 out
...
func (dev *FreqDevice) isADCEnabled() (enabled bool, err error) {
	...
	err = dev.deviceIoControl(0xC0, 0xB2, adcEnabled, 1, 1000) //0xC0 in, 0x40 out
...
func (dev *FreqDevice) UpdateADC() (err error) {
	...
	err = dev.deviceIoControl(0xC0, 0xB1, bdat, dataADCsize, 1000) //0xC0 in, 0x40 out
